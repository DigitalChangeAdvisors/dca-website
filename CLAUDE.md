...
- **El home sigue sin enlazar directo a `/lectores-fundadores`** — solo enruta a `/novela-returnai`, que es quien enruta a la cohorte. Sin precio, sin "comprar", sin cuenta regresiva. Verificado por grep en todo `index.html` tras el cambio.
